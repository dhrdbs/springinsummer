		...
		<div class="container">
			...
			<div class="row">
				...
				<c:forEach var="board" items="${board}" varStatus="status">
					...
					<a class="btn button " href="/hew/error_report/update?eno=${board.eno }"  onClick='fn_view(${list.eno})'
						role="button" style="float: right;">수정</a>
						</c:forEach>
				</div>
				...
				<c:forEach var="board" items="${board}" varStatus="status"> 
					<div class="jumbotron rounded">
						...
						<div class="col-md-12"
							...
							<a class="btn button " href="/hew/error_report/listAll" 
						role="button" style="float: right;">목록</a>
						</div>

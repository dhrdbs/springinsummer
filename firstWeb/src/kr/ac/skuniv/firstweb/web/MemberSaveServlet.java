...
//		out.print("<h1>비밀번호 : " + request.getParameter("password") + "</h1><br>");
//		out.print("<h1>이메일 : " + request.getParameter("email") + "입니다.</h1><br>");
//		out.print("<a href='memberForm.html>회원가입하러 가기!</a>");
//		
//		out.print("</body></html>");
